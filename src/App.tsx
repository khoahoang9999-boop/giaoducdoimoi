...
const APP_CATEGORIES = [
  {
    ...
    apps: [
      ...
      {
        id: 6,
        name: 'Thẩm Định Sáng Kiến Kinh Nghiệm',
        desc: 'Công cụ AI hỗ trợ thẩm định, đánh giá và chấm điểm Sáng kiến kinh nghiệm nhanh chóng, chính xác theo các tiêu chí.',
        icon: FileSearch,
        iconBg: 'bg-teal-600',
        views: 0,
        hot: true,
        ...
        price: 'Có Phí',
        guideLink: '#',
        loginLink: 'https://thamdinhskkn.onrender.com/',
        guideDetails: {
          title: "Thẩm Định Sáng Kiến Kinh Nghiệm",
          subtitle: "Công cụ AI hỗ trợ đánh giá SKKN",
          videoLink: "#",
          overview: "Hệ thống ứng dụng AI giúp hội đồng giám khảo và giáo viên tự đánh giá, thẩm định chất lượng Sáng kiến kinh nghiệm một cách khách quan, bám sát các tiêu chí chấm điểm hiện hành.",
          features: [
            { id: 1, title: "Phân tích tự động", desc: "Đọc file Word/PDF và phân tích nội dung chuyên sâu.", icon: Zap, color: "text-blue-500" },
            { id: 2, title: "Đánh giá tiêu chí", desc: "Chấm điểm dựa trên Tính mới, Tính khoa học, Tính thực tiễn.", icon: Check, color: "text-emerald-500" },
            { id: 3, title: "Góp ý chi tiết", desc: "Đưa ra các gợi ý chỉnh sửa để hoàn thiện SKKN.", icon: Lightbulb, color: "text-orange-500" }
          ],
          steps: [
            { step: 1, title: "Tải lên SKKN", desc: "Người dùng tải file Sáng kiến kinh nghiệm lên hệ thống." },
            { step: 2, title: "AI Thẩm định", desc: "Hệ thống tự động đọc, phân tích và đối chiếu với các tiêu chí chuẩn." },
            { step: 3, title: "Nhận kết quả", desc: "Xem báo cáo chi tiết về điểm số, nhận xét và các góp ý cải thiện." }
          ]
        }
      },
      {
        id: 7,
        name: 'Tạo Đề Kiểm Tra AI',
        desc: 'Công cụ AI hỗ trợ giáo viên tạo đề kiểm tra, ngân hàng câu hỏi trắc nghiệm và tự luận nhanh chóng, chính xác.',
        icon: FileText,
        ...
        price: 'Có Phí',
        guideLink: '#',
        loginLink: 'https://taodethionline-ai.onrender.com',
        guideDetails: {
          title: "Tạo Đề Kiểm Tra AI",
          subtitle: "Công cụ tạo đề thi, kiểm tra thông minh",
          videoLink: "#",
          overview: "Hệ thống AI giúp giáo viên tạo nhanh các đề kiểm tra trắc nghiệm, tự luận, ma trận đề thi từ văn bản, tài liệu hoặc chủ đề bất kỳ. Tiết kiệm tối đa thời gian ra đề.",
          features: [
            { id: 1, title: "Tạo đề thông minh", desc: "Tự động sinh câu hỏi từ tài liệu hoặc chủ đề yêu cầu.", icon: Zap, color: "text-blue-500" },
            { id: 2, title: "Đa dạng định dạng", desc: "Hỗ trợ câu hỏi trắc nghiệm, tự luận, và xuất ma trận đề.", icon: FileText, color: "text-emerald-500" },
            { id: 3, title: "Xuất file Word chuẩn", desc: "Dễ dàng xuất ra file Word định dạng chuẩn để in ấn.", icon: Check, color: "text-orange-500" }
          ],
          steps: [
            { step: 1, title: "Nhập nội dung", desc: "Tải lên tài liệu tham khảo hoặc nhập chủ đề bài học." },
            { step: 2, title: "Cấu hình đề thi", desc: "Chọn số lượng câu hỏi, mức độ khó dễ, định dạng trắc nghiệm hay tự luận." },
            { step: 3, title: "Xuất file", desc: "AI tự động tạo đề và đáp án. Tải ngay file Word về máy." }
          ]
        }
      }
    ]
          ...
          <div className="relative bg-white w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-3 bg-slate-50">
               ...
               <div className="bg-white rounded-2xl border border-slate-100 p-4 flex items-center shadow-sm">
                 ...
                 <div className="flex-1 text-[11px] sm:text-xs font-bold text-slate-700 leading-snug">
                   APP THẨM ĐỊNH SÁNG KIẾN KINH NGHIỆM (TRỌN ĐỜI)
                 </div>
                 <div className="text-red-500 font-black text-sm ml-3 shrink-0">LIÊN HỆ</div>
               </div>

               {/* App Tạo đề kiểm tra AI */}
               <div className="bg-white rounded-2xl border border-slate-100 p-4 flex items-center shadow-sm">
                 <div className="text-emerald-500 mr-3 shrink-0">
                   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                 </div>
                 <div className="flex-1 text-[11px] sm:text-xs font-bold text-slate-700 leading-snug">
                   APP TẠO ĐỀ KIỂM TRA AI (TRỌN ĐỜI)
                 </div>
                 <div className="text-red-500 font-black text-sm ml-3 shrink-0">LIÊN HỆ</div>
               </div>
